Алгоритм Дейкстры (только с НАПРАВЛЕННЫМИ АЦИКЛИЧЕСКИМИ графами, также не может использоваться при наличии ребер,
имеющих отрицательный вес (для этого алгоритм Беллмана-Форда)).
